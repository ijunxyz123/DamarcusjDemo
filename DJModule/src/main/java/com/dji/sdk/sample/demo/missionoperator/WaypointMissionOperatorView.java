...
public class WaypointMissionOperatorView extends MissionBaseView {
    ...
    public void onClick(View v) {
        ...
        } else if (i == R.id.btn_set_maximum_altitude) {
            if (getFlightController() != null) {
        ...
        } else if (i == R.id.btn_set_maximum_radius) {
            if (getFlightController() != null) {
        ...
        } else if (i == R.id.btn_start) {// Example of starting a Mission
            if (mission != null) {
        ...
        } else if (i == R.id.btn_stop) {// Example of stopping a Mission
        ...
        } else if (i == R.id.btn_pause) {// Example of pausing an executing Mission
        ...
        } else if (i == R.id.btn_resume) {// Example of resuming a paused Mission
        ...
        } else if (i == R.id.btn_download) {// Example of downloading an executing Mission
