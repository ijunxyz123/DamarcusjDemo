...
public class GimbalCapabilityView extends LinearLayout implements View.OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.btn_pitchMin) {
            rotateGimbalToMin((Button) v);
        } else if (i == R.id.btn_pitchMax) {
            rotateGimbalToMax((Button) v);
        } else if (i == R.id.btn_yawMin) {
            rotateGimbalToMin((Button) v);
        } else if (i == R.id.btn_yawMax) {
            rotateGimbalToMax((Button) v);
        } else if (i == R.id.btn_rollMin) {
            rotateGimbalToMin((Button) v);
        } else if (i == R.id.btn_rollMax) {
            rotateGimbalToMax((Button) v);
        ...
        } else if (i == R.id.video_feeder_left_fpv) {
            onClickLeftAndFpvBtn();
        } else if (i == R.id.video_feeder_right_fpv) {
            onClickRightAndFpvBtn();
        } else if (i == R.id.video_feeder_left_right) {
