...
public class TimelineMissionControlView extends LinearLayout implements OnClickListener, PresentableView {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.btn_timeline_init) {
            initTimeline();

        } else if (i == R.id.btn_timeline_start) {
            startTimeline();

        } else if (i == R.id.btn_timeline_stop) {
            stopTimeline();

        } else if (i == R.id.btn_timeline_pause) {
        ...
        } else if (i == R.id.btn_timeline_resume) {
        ...
        } else if (i == R.id.btn_timeline_clean) {
